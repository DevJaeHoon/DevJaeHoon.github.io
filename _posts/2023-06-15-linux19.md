...
## 멀티 쓰레드
하나의 프로그램 안에 여러개의 main을 사용할 수 있다.


`gcc ./chat_serv.c -D_REENTRANT -o ./cserv -lpthread` 후 `./cserv 12345`

`gcc ./chat_clnt.c -D_REENTRANT -o ./cclnt -lpthread` 후 `./cclnt 3.36.74.128 12345 Jaehoon`
